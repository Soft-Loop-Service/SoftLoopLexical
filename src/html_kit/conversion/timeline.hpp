    ...
    namespace Conversion
    {
        ...
        private:
            ...
            void process(int process_index, int kit_index)
            {
                ...
                SyntacticTreeNode node = (*syntactic_analysis_tree_p)[process_unit.node_index];
        ...
        public:
            Timeline(vSyntacticTree *syntactic_analysis_tree_p, ProcessVisualization::vProcessAnalysis *process_result_p, ProcessVisualization::VariablePossessionUnion *variable_possession_union_p,vLexicalToken *token_string_vector_p)
            {
