...
#ifndef __SOFTJ_INLINE_ARRAY
#define __SOFTJ_INLINE_ARRAY
...
namespace LanguageSpecifications
{
    ...
    {
        inline void Softj::resolutionCalcMakeArray(int pointer, vint &length_list, string array_type, int depth)
        {
        ...
        inline void Softj::resolutionCalcArrayLength(int node_index, vint &length_list)
        {
        ...
        inline void Softj::resolutionCalcNewArray(int node_index, int pointer)
        {
            SyntacticTreeNode current_node = (*syntactic_analysis_tree)[node_index];
        ...
        inline void Softj::resolutionCalcArray(int node_index, int &pointer)
        {
            SyntacticTreeNode current_node = (*syntactic_analysis_tree)[node_index];
            ...
            SyntacticTreeNode array_index_node = (*syntactic_analysis_tree)[array_name_index];
        ...
        inline int Softj::resolutionTreeCalcArray(int node_index)
        {
            SyntacticTreeNode current_node = (*syntactic_analysis_tree)[node_index];
