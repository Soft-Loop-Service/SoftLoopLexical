...
#ifndef __SOFTJ_INLINE_PE
#define __SOFTJ_INLINE_PE
...
namespace LanguageSpecifications
{
    namespace SoftjLanguage
    {
            ...
            inline void Softj::preparationValueEnumeration(int node_index, vValueEnumeration &args_type)
            {
            ...
            inline void Softj::preparationFunctionMessagePassing(int node_index)
            {
                SyntacticTreeNode node = (*syntactic_analysis_tree)[node_index];
            ...
            // 関数定義について、予め軽く解析しておく
            inline void Softj::preparationFunction(int node_index)
            {
                SyntacticTreeNode node = (*syntactic_analysis_tree)[node_index];
            ...
            // 予め軽く木構造を走査しておく
            inline void Softj::preparationTree()
            {
